  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Entrenamiento y concienciación en ciberseguridad
        p.mb-4 Desarrollar un marco conceptual que permita promover una cultura organizacional centrada en la comprensión y aplicación de principios de seguridad digital.
